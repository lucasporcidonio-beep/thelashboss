      ...
      <div className="container mx-auto px-6">
        <div ref={ref} className="max-w-2xl mx-auto text-center">
          ...
          <motion.h2
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-8 leading-tight text-foreground"
          >
          ...
          <motion.div
            ...
            className="space-y-6 text-foreground/60 font-body text-base md:text-lg leading-relaxed"
          >
            <p>
            ...
            <p className="text-foreground/80 font-medium italic font-display text-xl">
